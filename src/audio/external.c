...
void set_character_sound() {
    if (gCurrentObject->behavior == segmented_to_virtual(bhvMario)) {
        ...
        SOUND_CHARACTER_HAHA_WATER = SOUND_MARIO_HAHA;
        SOUND_CHARACTER_UH_LEDGE_CLIMB_FAST = SOUND_MARIO_UH;
        SOUND_CHARACTER_UH_LONG_JUMP_LAND = SOUND_MARIO_UH;
    ...
    if (gCurrentObject->behavior == segmented_to_virtual(bhvLuigi)) {
    ...
    if (gCurrentObject->behavior == segmented_to_virtual(bhvSyobon)) {
        SOUND_CHARACTER_YAH_WAH_HOO = SOUND_WARIO_YAH_WAH_HOO;
