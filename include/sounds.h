...
/* Luigi Sound Effects */
// A random number 0-2 is added to the sound ID before playing, producing Yah/Wah/Hoo
#define SOUND_LUIGI_YAH_WAH_HOO                  /* 0x64008081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x40, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_HOOHOO                       /* 0x64038081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x43, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
#define SOUND_LUIGI_YAHOO                        /* 0x64048081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x44, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
#define SOUND_LUIGI_UH                           /* 0x64058081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x45, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
#define SOUND_LUIGI_HRMM                         /* 0x64068081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x46, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
#define SOUND_LUIGI_WAH2                         /* 0x64078081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x47, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
#define SOUND_LUIGI_WHOA                         /* 0x64088081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x48, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
#define SOUND_LUIGI_EEUH                         /* 0x64098081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x49, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
#define SOUND_LUIGI_ATTACKED                     /* 0x640AFF81 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x4A, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
#define SOUND_LUIGI_OOOF                         /* 0x640B8081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x4B, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
#define SOUND_LUIGI_OOOF2                        /* 0x640BD081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x4B, 0xD0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
#define SOUND_LUIGI_HERE_WE_GO                   /* 0x640C8081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x4C, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_YAWNING                      /* 0x640D8081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x4D, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
#define SOUND_LUIGI_SNORING1                     /* 0x640E8081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x4E, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_SNORING2                     /* 0x640F8081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x4F, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_WAAAOOOW                     /* 0x6410C081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x50, 0xC0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
#define SOUND_LUIGI_HAHA                         /* 0x64118081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x51, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
#define SOUND_LUIGI_HAHA_WATER                   /* 0x6411F081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x51, 0xF0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
#define SOUND_LUIGI_UH_LEDGE_CLIMB_FAST          /* 0x6413D081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x53, 0xD0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
#define SOUND_LUIGI_UH_LONG_JUMP_LAND            /* 0x64138081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x53, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
#define SOUND_LUIGI_ON_FIRE                      /* 0x6414A081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x54, 0xA0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
#define SOUND_LUIGI_DYING                        /* 0x6415FF81 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x55, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
#define SOUND_LUIGI_PANTING_COLD                 /* 0x64168081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x56, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

// A random number 0-2 is added to the sound ID before playing
#define SOUND_LUIGI_PANTING                     SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1, 0x58, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

#define SOUND_LUIGI_COUGHING1                   SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1, 0x5B, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_COUGHING2                   SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1, 0x5C, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_COUGHING3                   SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1, 0x5D, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_PUNCH_YAH                   SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1, 0x5E, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_PUNCH_HOO                   SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1, 0x5F, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_MAMA_MIA                    SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1, 0x60, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_OKEY_DOKEY                  SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1, 0x61, 0x40, 0) // unused
#define SOUND_LUIGI_GROUND_POUND_WAH            SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1, 0x62, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_DROWNING                    SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1, 0x63, 0xF0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_PUNCH_WAH                   SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1, 0x64, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

// A random number 0-4 is added to the sound ID before playing, producing one of
// Yahoo! (60% chance), Waha! (20%), or Yippee! (20%).
#define SOUND_LUIGI_YAHOO_WAHA_YIPPEE           SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1, 0x6B, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

#define SOUND_LUIGI_DOH                         SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1, 0x70, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_GAME_OVER                   SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1, 0x71, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_HELLO                       SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1, 0x72, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_PRESS_START_TO_PLAY         SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1, 0x73, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_NO_ECHO | SOUND_DISCRETE)
#define SOUND_LUIGI_TWIRL_BOUNCE                SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1, 0x74, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_SNORING3                    SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1, 0x75, 0x40, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_SO_LONGA_BOWSER             SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1, 0x76, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_IMA_TIRED                   SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1, 0x77, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
