...
// A random number 0-2 is added to the sound ID before playing
#define SOUND_LUIGI_PANTING                      /* 0x24188081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x18, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

#define SOUND_LUIGI_COUGHING1                    /* 0x241B8081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x1B, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_COUGHING2                    /* 0x241C8081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x1C, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_COUGHING3                    /* 0x241D8081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x1D, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_PUNCH_YAH                    /* 0x241E8081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x1E, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_PUNCH_HOO                    /* 0x241F8081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x1F, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_MAMA_MIA                     /* 0x24208081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x20, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_OKEY_DOKEY                   /* 0x20210001 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x21, 0x00, 0) // unused
#define SOUND_LUIGI_GROUND_POUND_WAH             /* 0x24228081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x22, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_DROWNING                     /* 0x2423F081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x23, 0xF0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_PUNCH_WAH                    /* 0x24248081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x24, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

/* LUIGI Sound Effects (US/EU only) */
#define SOUND_PEACH_DEAR_LUIGI                   /* 0x2428FF81 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x28, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

// A random number 0-4 is added to the sound ID before playing, producing one of
// Yahoo! (60% chance), Waha! (20%), or Yippee! (20%).
#define SOUND_LUIGI_YAHOO_WAHA_YIPPEE            /* 0x242B8081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x2B, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

#define SOUND_LUIGI_DOH                          /* 0x24308081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x30, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_GAME_OVER                    /* 0x2431FF81 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x31, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_HELLO                        /* 0x2432FF81 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x32, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_PRESS_START_TO_PLAY          /* 0x2433FFA1 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x33, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_NO_ECHO | SOUND_DISCRETE)
#define SOUND_LUIGI_TWIRL_BOUNCE                 /* 0x24348081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x34, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_SNORING3                     /* 0x2435FF81 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x35, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_SO_LONGA_BOWSER              /* 0x24368081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x36, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_IMA_TIRED                    /* 0x24378081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND1,    0x37, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
